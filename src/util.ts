...
export const isElectron =
    typeof navigator === 'undefined' ? false : /electron/i.test(navigator.userAgent);
...
export const sortTiles = sortWith([ascend(colorSort), ascend(idBaseSort), ascend(idExtraSort)]);
